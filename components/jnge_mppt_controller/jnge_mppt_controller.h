...
class JngeMpptController : public PollingComponent, public jnge_modbus::JngeModbusDevice {
 ...
 protected:
  ...
  sensor::Sensor *channel_a_current_sensor_{nullptr};
  sensor::Sensor *channel_b_current_sensor_{nullptr};
  ...
  sensor::Sensor *discharge_current_sensor_{nullptr};
  sensor::Sensor *discharge_times_sensor_{nullptr};
  sensor::Sensor *total_charging_energy_sensor_{nullptr};
  ...
  sensor::Sensor *controller_voltage_level_sensor_{nullptr};
  sensor::Sensor *pv_standby_voltage_sensor_{nullptr};
  sensor::Sensor *controller_current_level_sensor_{nullptr};
  sensor::Sensor *battery_temperature_compensation_voltage_point_sensor_{nullptr};
  sensor::Sensor *battery_strings_sensor_{nullptr};

  // configuration
  sensor::Sensor *battery_overvoltage_sensor_{nullptr};
  sensor::Sensor *charging_limit_voltage_sensor_{nullptr};
  sensor::Sensor *battery_overvoltage_recovery_sensor_{nullptr};
  sensor::Sensor *equalizing_charging_voltage_sensor_{nullptr};
  sensor::Sensor *boost_charging_voltage_sensor_{nullptr};
  sensor::Sensor *boost_charging_return_voltage_sensor_{nullptr};
  sensor::Sensor *floating_charge_voltage_sensor_{nullptr};
  sensor::Sensor *over_discharge_voltage_sensor_{nullptr};
  sensor::Sensor *over_discharge_recovery_voltage_sensor_{nullptr};
  sensor::Sensor *battery_undervoltage_sensor_{nullptr};
  sensor::Sensor *equalization_charging_time_sensor_{nullptr};
  sensor::Sensor *improve_charging_time_sensor_{nullptr};
  sensor::Sensor *temperature_compensation_coefficient_sensor_{nullptr};
  sensor::Sensor *device_address_sensor_{nullptr};
  sensor::Sensor *light_control_on_voltage_sensor_{nullptr};
  sensor::Sensor *light_control_off_voltage_sensor_{nullptr};
  sensor::Sensor *light_control_on_period_1_sensor_{nullptr};
  sensor::Sensor *light_control_on_period_2_sensor_{nullptr};
  sensor::Sensor *load_turn_off_time_sensor_{nullptr};

  select::Select *battery_type_select_{nullptr};

  number::Number *battery_overvoltage_number_{nullptr};
  number::Number *charging_limit_voltage_number_{nullptr};
  number::Number *battery_overvoltage_recovery_number_{nullptr};
  number::Number *equalizing_charging_voltage_number_{nullptr};
  number::Number *boost_charging_voltage_number_{nullptr};
  number::Number *boost_charging_return_voltage_number_{nullptr};
  number::Number *floating_charge_voltage_number_{nullptr};
  number::Number *over_discharge_voltage_number_{nullptr};
  number::Number *over_discharge_recovery_voltage_number_{nullptr};
  number::Number *battery_undervoltage_number_{nullptr};
  number::Number *equalization_charging_time_number_{nullptr};
  number::Number *improve_charging_time_number_{nullptr};
  number::Number *temperature_compensation_coefficient_number_{nullptr};
  number::Number *device_address_number_{nullptr};
  number::Number *light_control_on_voltage_number_{nullptr};
  number::Number *light_control_off_voltage_number_{nullptr};
  number::Number *light_control_on_period_1_number_{nullptr};
  number::Number *light_control_on_period_2_number_{nullptr};
  number::Number *load_turn_off_time_number_{nullptr};
  number::Number *battery_strings_number_{nullptr};
